# Pixel regression — RC 7a7e1d7 vs de5d319 (existing faces only)
...
PIXEL_REGRESSION existing faces compared: 126 (same 75, time-dependent 39, nondeterministic 2, differ 10)
  ...
  meeting.workspace                    light   0.21%  1571 px  [time-dependent fixture]
  meeting.workspace                    dark    0.22%  1634 px  [time-dependent fixture]
  recording.meeting-canvas             light   0.49%  3623 px  [time-dependent fixture]
  recording.meeting-canvas             dark    0.24%  1753 px  [time-dependent fixture]
  main.home                            light   0.06%  597 px  [time-dependent fixture]
  main.home                            dark    0.06%  609 px  [time-dependent fixture]
  main.home-recording-now              light   0.18%  1846 px  [time-dependent fixture]
  main.home-recording-now              dark    0.19%  1884 px  [time-dependent fixture]
  ...
  main.apps-plugins                    light   0.38%  3880 px  [nondeterministic fixture: プラグインのタイルの色が run ごとに変わる（並びは同じ）。色の種が順序の無い集合から来ている疑い。0.3〜0.5% の差。]
  main.apps-plugins                    dark    0.17%  1737 px  [nondeterministic fixture: プラグインのタイルの色が run ごとに変わる（並びは同じ）。色の種が順序の無い集合から来ている疑い。0.3〜0.5% の差。]
  ...
  provenance.library-after-end         light   0.22%  2250 px  [time-dependent fixture]
  provenance.source                    light   0.22%  2250 px  [time-dependent fixture]
  provenance.reopened                  light   0.22%  2250 px  [time-dependent fixture]
  ...
  system.interrupted-journey           light   0.16%  1655 px  [time-dependent fixture]
  system.resumed                       light   0.22%  2250 px  [time-dependent fixture]
  ...
  system.generic-failure               light   1.73%  17553 px  [time-dependent fixture]
