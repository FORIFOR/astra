# Pixel regression — RC b10b7ca vs de5d319 (existing faces only)

```
PIXEL_REGRESSION existing faces compared: 126 (same 75, time-dependent 39, nondeterministic 2, differ 10)
  ...
  meeting.workspace                    light   0.17%  1278 px  [time-dependent fixture]
  meeting.workspace                    dark    0.17%  1269 px  [time-dependent fixture]
  recording.meeting-canvas             light   0.49%  3605 px  [time-dependent fixture]
  recording.meeting-canvas             dark    0.32%  2348 px  [time-dependent fixture]
  main.home                            light   0.26%  2613 px  [time-dependent fixture]
  main.home                            dark    0.27%  2795 px  [time-dependent fixture]
  main.home-recording-now              light   0.13%  1312 px  [time-dependent fixture]
  main.home-recording-now              dark    0.12%  1224 px  [time-dependent fixture]
  ...
  main.apps-plugins                    light   0.24%  2462 px  [nondeterministic fixture: プラグインのタイルの色が run ごとに変わる（並びは同じ）。色の種が順序の無い集合から来ている疑い。0.3〜0.5% の差。]
  main.apps-plugins                    dark    0.17%  1736 px  [nondeterministic fixture: プラグインのタイルの色が run ごとに変わる（並びは同じ）。色の種が順序の無い集合から来ている疑い。0.3〜0.5% の差。]
  ...
  provenance.library-after-end         light   0.12%  1214 px  [time-dependent fixture]
  provenance.source                    light   0.12%  1214 px  [time-dependent fixture]
  provenance.reopened                  light   0.12%  1214 px  [time-dependent fixture]
  ...
  system.interrupted-journey           light   0.33%  3345 px  [time-dependent fixture]
  system.resumed                       light   0.12%  1214 px  [time-dependent fixture]
  ...
  system.generic-failure               light   1.93%  19595 px  [time-dependent fixture]
  system.generic-failure               dark   14.13%  143674 px  [time-dependent fixture]
