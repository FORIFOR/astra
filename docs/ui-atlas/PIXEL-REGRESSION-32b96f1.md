# Pixel regression — RC 32b96f1 vs de5d319 (existing faces only)
...
PIXEL_REGRESSION existing faces compared: 126 (same 76, time-dependent 38, nondeterministic 2, differ 10)
  ...
  meeting.workspace                    light   0.21%  1566 px  [time-dependent fixture]
  meeting.workspace                    dark    0.22%  1610 px  [time-dependent fixture]
  ...
  main.home-recording-now              light   0.15%  1538 px  [time-dependent fixture]
  main.home-recording-now              dark    0.15%  1567 px  [time-dependent fixture]
  ...
  main.apps-plugins                    light   0.32%  3272 px  [nondeterministic fixture: プラグインのタイルの色が run ごとに変わる（並びは同じ）。色の種が順序の無い集合から来ている疑い。0.3〜0.5% の差。]
  main.apps-plugins                    dark    0.52%  5296 px  [nondeterministic fixture: プラグインのタイルの色が run ごとに変わる（並びは同じ）。色の種が順序の無い集合から来ている疑い。0.3〜0.5% の差。]
  ...
  provenance.library-after-end         light   0.22%  2242 px  [time-dependent fixture]
  provenance.source                    light   0.22%  2242 px  [time-dependent fixture]
  provenance.reopened                  light   0.22%  2242 px  [time-dependent fixture]
  ...
  system.interrupted-journey           light   0.16%  1644 px  [time-dependent fixture]
  system.resumed                       light   0.22%  2242 px  [time-dependent fixture]
