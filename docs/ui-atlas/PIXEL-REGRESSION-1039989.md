# Pixel regression — RC 1039989 vs de5d319 (existing faces only)
...
PIXEL_REGRESSION existing faces compared: 126 (same 75, time-dependent 39, nondeterministic 2, differ 10)
  ...
  meeting.workspace                    light   0.21%  1572 px  [time-dependent fixture]
  meeting.workspace                    dark    0.22%  1617 px  [time-dependent fixture]
  recording.meeting-canvas             light   0.22%  1588 px  [time-dependent fixture]
  recording.meeting-canvas             dark    0.00%  0 px  [time-dependent fixture]
  main.home                            light   0.06%  597 px  [time-dependent fixture]
  main.home                            dark    0.06%  609 px  [time-dependent fixture]
  main.home-recording-now              light   0.18%  1842 px  [time-dependent fixture]
  main.home-recording-now              dark    0.15%  1574 px  [time-dependent fixture]
  ...
  main.apps-plugins                    light   0.38%  3830 px  [nondeterministic fixture: プラグインのタイルの色が run ごとに変わる（並びは同じ）。色の種が順序の無い集合から来ている疑い。0.3〜0.5% の差。]
  main.apps-plugins                    dark    0.39%  3964 px  [nondeterministic fixture: プラグインのタイルの色が run ごとに変わる（並びは同じ）。色の種が順序の無い集合から来ている疑い。0.3〜0.5% の差。]
  ...
  provenance.library-after-end         light   0.22%  2239 px  [time-dependent fixture]
  provenance.source                    light   0.22%  2239 px  [time-dependent fixture]
  provenance.reopened                  light   0.22%  2239 px  [time-dependent fixture]
  ...
  system.interrupted-journey           light   0.16%  1651 px  [time-dependent fixture]
  system.resumed                       light   0.22%  2239 px  [time-dependent fixture]
  ...
  system.generic-failure               dark   13.91%  141459 px  [time-dependent fixture]
