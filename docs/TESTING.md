...
| -------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| See the result first | [Watch three real workflows](https://genie-forifor.forifor.chatgpt.site/#demos) or [explore the orbital HTML sample](https://genie-forifor.forifor.chatgpt.site/orbit.html). Share what you would want to use it for. | Browser only. This is a demonstration, not a hosted Genie session or a Mac app test. |
