...
const FIELDS = [
  ...
  ['hudShellTopInset', h.shellTopInset],
  ['hudShellShoulder', h.shellShoulder],
  ['hudShellLowerTop', h.shellLowerTop],
  ['hudShellLowerBottom', h.shellLowerBottom],
  ['hudShellBottomInset', h.shellBottomInset],
  ['hudShellFlarePull', h.shellFlarePull],
  ['hudShellCornerPull', h.shellCornerPull],
  ['hudInnerWidth', h.innerWidth],
  ['hudInnerHeight', h.innerHeight],
  ['hudInnerOffset', h.innerOffset],
  ['hudInnerRadius', h.innerRadius],
  ['hudOrbSize', h.orbSize],
  ['dockPanelGap', h.panelGap],
  ['discoveryWidth', h.discoveryWidth],
  ['discoveryHeight', h.discoveryHeight],
  ['quickActionsWidth', h.quickActionsWidth],
  ['quickActionsHeight', h.quickActionsHeight],
