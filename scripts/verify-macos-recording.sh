...
for t in screenshot waveform livemic livemeeting livescreen sttrecognize sttstream guishot axtree a11ynames navtitle recoveryui focus upgrade breakpoints dictation state presence perf storage meetingiq vad browser dockanim entry update secret recordbutton session uiscale acceptance sessionsync; do
