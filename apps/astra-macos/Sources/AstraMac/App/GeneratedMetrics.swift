...
enum Metrics {
    ...
    static let hudHeight: CGFloat = 46
    static let hudBottomRadius: CGFloat = 16
    static let dockIdleWidth: CGFloat = 220
    static let dockIdleHeight: CGFloat = 46
    static let dockContextWidth: CGFloat = 300
    static let dockContextHeight: CGFloat = 46
    static let dockContextExpandedWidth: CGFloat = 420
    static let dockContextExpandedBase: CGFloat = 124
    static let dockListeningWidth: CGFloat = 560
    static let dockListeningHeight: CGFloat = 120
    static let dockThinkingWidth: CGFloat = 520
    static let dockThinkingHeight: CGFloat = 84
    static let dockAgentWidth: CGFloat = 680
    static let dockAgentHeightBase: CGFloat = 150
    static let dockAgentRowHeight: CGFloat = 34
    static let dockConfirmWidth: CGFloat = 600
    static let dockConfirmHeight: CGFloat = 230
    static let dockMeetingWidth: CGFloat = 600
    static let dockMeetingHeight: CGFloat = 70
    static let dockMeetingExpandedHeight: CGFloat = 300
    ...
    static let dockPadH: CGFloat = 18
    static let dockPadV: CGFloat = 10
