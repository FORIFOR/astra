...
enum Metrics {
    ...
    static let hudWidth: CGFloat = 374
    static let hudHeight: CGFloat = 68
    static let hudBottomRadius: CGFloat = 17
    static let hudShellTopInset: CGFloat = 42
    static let hudShellShoulder: CGFloat = 18
    static let hudShellLowerTop: CGFloat = 27
    static let hudShellLowerBottom: CGFloat = 67
    static let hudShellBottomInset: CGFloat = 48
    static let hudShellFlarePull: CGFloat = 6
    static let hudShellCornerPull: CGFloat = 20
    static let hudInnerWidth: CGFloat = 322
    static let hudInnerHeight: CGFloat = 35
    static let hudInnerOffset: CGFloat = 27
    static let hudInnerRadius: CGFloat = 17.5
    static let hudOrbSize: CGFloat = 10
    static let dockPanelGap: CGFloat = 7
    static let discoveryWidth: CGFloat = 264
    static let discoveryHeight: CGFloat = 96
    static let quickActionsWidth: CGFloat = 300
    static let quickActionsHeight: CGFloat = 64
