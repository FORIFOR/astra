...
#endif
#ifndef UNIFFI_FFIDEF_UNIFFI_ASTRA_CORE_CHECKSUM_FUNC_CONNECTOR_PARSE_CALLBACK
#define UNIFFI_FFIDEF_UNIFFI_ASTRA_CORE_CHECKSUM_FUNC_CONNECTOR_PARSE_CALLBACK
uint16_t uniffi_astra_core_checksum_func_connector_parse_callback(void
