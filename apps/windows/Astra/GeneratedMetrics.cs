...
public static class Metrics
{
    ...
    public const double HudHeight = 46;
    public const double HudBottomRadius = 16;
    public const double DockIdleWidth = 220;
    public const double DockIdleHeight = 46;
    public const double DockContextWidth = 300;
    public const double DockContextHeight = 46;
    public const double DockContextExpandedWidth = 420;
    public const double DockContextExpandedBase = 124;
    public const double DockListeningWidth = 560;
    public const double DockListeningHeight = 120;
    public const double DockThinkingWidth = 520;
    public const double DockThinkingHeight = 84;
    public const double DockAgentWidth = 680;
    public const double DockAgentHeightBase = 150;
    public const double DockAgentRowHeight = 34;
    public const double DockConfirmWidth = 600;
    public const double DockConfirmHeight = 230;
    public const double DockMeetingWidth = 600;
    public const double DockMeetingHeight = 70;
    public const double DockMeetingExpandedHeight = 300;
    ...
    public const double DockPadH = 18;
    public const double DockPadV = 10;
