...
public static class Metrics
{
    ...
    public const double HudWidth = 374;
    public const double HudHeight = 68;
    public const double HudBottomRadius = 17;
    public const double HudShellTopInset = 42;
    public const double HudShellShoulder = 18;
    public const double HudShellLowerTop = 27;
    public const double HudShellLowerBottom = 67;
    public const double HudShellBottomInset = 48;
    public const double HudShellFlarePull = 6;
    public const double HudShellCornerPull = 20;
    public const double HudInnerWidth = 322;
    public const double HudInnerHeight = 35;
    public const double HudInnerOffset = 27;
    public const double HudInnerRadius = 17.5;
    public const double HudOrbSize = 10;
    public const double DockPanelGap = 7;
    public const double DiscoveryWidth = 264;
    public const double DiscoveryHeight = 96;
    public const double QuickActionsWidth = 300;
    public const double QuickActionsHeight = 64;
