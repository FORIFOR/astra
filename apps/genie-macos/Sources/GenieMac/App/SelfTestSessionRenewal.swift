...
extension SelfTest {
    @MainActor static func sessionRenewal() async {
        ...
        do {
            ...
            let me = try await Task.detached { try GenieCoreBridge.me(base, accessToken: first.accessToken) }.value
            ...
            let after = try await Task.detached { try GenieCoreBridge.me(base, accessToken: restored.accessToken) }.value
