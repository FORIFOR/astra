...
/// Genie が今あなたについて使っている情報。Work Context 仕様 §Personalization。
///
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                if let p = store.profile {
                    ...
                    if p.inferenceEnabled {
                        ...
                        Text("観測 = 記録から数えたこと · 推測 = そこから Genie が考えたこと · 確認済み = あなたが認めたこと")
                        ...
                        Text("推測を止めています。Genie は、あなたが確認した情報も含めて何も使いません。")
        ...
        VStack(alignment: .leading, spacing: 8) {
            ...
            HStack(spacing: 8) {
                if t.enabled {
                    ...
                    .buttonStyle(GenieControlStyle(radius: 6, base: confirmed ? 0.0 : 0.05, filled: !confirmed))
