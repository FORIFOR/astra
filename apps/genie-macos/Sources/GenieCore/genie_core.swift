...
#if canImport(genie_coreFFI)
import genie_coreFFI
#endif
...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_genie_core_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_genie_core_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsureGenieCoreInitialized()
...
open class RecordingSession: RecordingSessionProtocol, @unchecked Sendable {
    ...
    public func uniffiClonePointer() -> UnsafeMutableRawPointer {
        return try! rustCall { uniffi_genie_core_fn_clone_recordingsession(self.pointer, $0) }
    }
    ...
    deinit {
        ...
        try! rustCall { uniffi_genie_core_fn_free_recordingsession(pointer, $0) }
    }
...
public static func start(root: String, meetingId: String)throws  -> RecordingSession  {
    ...
    uniffi_genie_core_fn_constructor_recordingsession_start(
...
open func finish()throws   {try rustCallWithError(FfiConverterTypeSessionError_lift) {
    uniffi_genie_core_fn_method_recordingsession_finish(self.uniffiClonePointer(),$0
    )
}
}
...
open func meetingId() -> String  {
    ...
    uniffi_genie_core_fn_method_recordingsession_meeting_id(self.uniffiClonePointer(),$0
    )
})
}
...
open func pushSamples(samples: [Float], sampleRate: UInt32) -> UInt32  {
    ...
    uniffi_genie_core_fn_method_recordingsession_push_samples(self.uniffiClonePointer(),
...
open func recordedMs() -> UInt64  {
    ...
    uniffi_genie_core_fn_method_recordingsession_recorded_ms(self.uniffiClonePointer(),$0
    )
})
}
...
open func setLink(link: LinkState, pendingMs: UInt64)  {try! rustCall() {
    uniffi_genie_core_fn_method_recordingsession_set_link(self.uniffiClonePointer(),
...
open func setPaused(paused: Bool)  {try! rustCall() {
    uniffi_genie_core_fn_method_recordingsession_set_paused(self.uniffiClonePointer(),
...
open func snapshot() -> RecordingSnapshot  {
    ...
    uniffi_genie_core_fn_method_recordingsession_snapshot(self.uniffiClonePointer(),$0
    )
})
}
...
public struct FfiConverterTypeRecordingSnapshot: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> RecordingSnapshot {
        return
            try RecordingSnapshot(
                mode: FfiConverterTypeGenieMode.read(from: &buf), 
    ...
    public static func write(_ value: RecordingSnapshot, into buf: inout [UInt8]) {
        FfiConverterTypeGenieMode.write(value.mode, into: &buf)
...
#if compiler(>=6)
extension GenieMode: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeGenieMode: FfiConverterRustBuffer {
    typealias SwiftType = GenieMode

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> GenieMode {
        let variant: Int32 = try readInt(&buf)
        switch variant {
    ...
    public static func write(_ value: GenieMode, into buf: inout [UInt8]) {
        switch value {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeGenieMode_lift(_ buf: RustBuffer) throws -> GenieMode {
    return try FfiConverterTypeGenieMode.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeGenieMode_lower(_ value: GenieMode) -> RustBuffer {
    return FfiConverterTypeGenieMode.lower(value)
}


extension GenieMode: Equatable, Hashable {}
...
public func apiArtifactContent(baseUrl: String, accessToken: String, artifactId: String)throws  -> String  {
    ...
    uniffi_genie_core_fn_func_api_artifact_content(
...
public func apiCreateMeeting(baseUrl: String, accessToken: String, title: String, language: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeApiError_lift) {
    uniffi_genie_core_fn_func_api_create_meeting(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),
...
public func apiCreateTask(baseUrl: String, accessToken: String, kind: String, inputJson: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeApiError_lift) {
    uniffi_genie_core_fn_func_api_create_task(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),
...
public func apiDevSignIn(baseUrl: String, email: String, displayName: String)throws  -> Tokens  {
    ...
    uniffi_genie_core_fn_func_api_dev_sign_in(
        FfiConverterString.lower(baseUrl),
...
public func apiFinishMeeting(baseUrl: String, accessToken: String, meetingId: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeApiError_lift) {
    uniffi_genie_core_fn_func_api_finish_meeting(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),
        FfiConverterString.lower(meetingId),$0
    )
...
public func apiInitialProfile(baseUrl: String, accessToken: String, operation: String, bodyJson: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeApiError_lift) {
    uniffi_genie_core_fn_func_api_initial_profile(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),
...
public func apiLibrary(baseUrl: String, accessToken: String)throws  -> [String]  {
    ...
    uniffi_genie_core_fn_func_api_library(
        FfiConverterString.lower(baseUrl),
...
public func apiMe(baseUrl: String, accessToken: String)throws  -> Me  {
    ...
    uniffi_genie_core_fn_func_api_me(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),$0
    )
})
...
public func apiMeetingSegmentCount(baseUrl: String, accessToken: String, meetingId: String)throws  -> UInt32  {
    ...
    uniffi_genie_core_fn_func_api_meeting_segment_count(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),
        FfiConverterString.lower(meetingId),$0
    )
...
public func apiPersonalization(baseUrl: String, accessToken: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeApiError_lift) {
    uniffi_genie_core_fn_func_api_personalization(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),$0
    )
})
...
public func apiPersonalizationUpdate(baseUrl: String, accessToken: String, updateJson: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeApiError_lift) {
    uniffi_genie_core_fn_func_api_personalization_update(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),
...
public func apiPluginCatalog(baseUrl: String, accessToken: String)throws  -> [String]  {
    return try  FfiConverterSequenceString.lift(try rustCallWithError(FfiConverterTypeApiError_lift) {
    uniffi_genie_core_fn_func_api_plugin_catalog(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),$0
    )
})
...
public func apiPluginConnect(baseUrl: String, accessToken: String, pluginId: String, connectJson: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeApiError_lift) {
    uniffi_genie_core_fn_func_api_plugin_connect(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),
...
public func apiPluginConnections(baseUrl: String, accessToken: String, pluginId: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeApiError_lift) {
    uniffi_genie_core_fn_func_api_plugin_connections(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),
...
public func apiPluginDisconnect(baseUrl: String, accessToken: String, pluginId: String, connectorId: String)throws   {try rustCallWithError(FfiConverterTypeApiError_lift) {
    uniffi_genie_core_fn_func_api_plugin_disconnect(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),
        FfiConverterString.lower(pluginId),
...
public func apiSendTurn(baseUrl: String, accessToken: String, conversationId: String, text: String)throws  -> TurnOutcome  {
    ...
    uniffi_genie_core_fn_func_api_send_turn(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),
...
public func apiSendTurnWithAttachments(baseUrl: String, accessToken: String, conversationId: String, text: String, attachments: [TurnAttachment])throws  -> TurnOutcome  {
    return try  FfiConverterTypeTurnOutcome_lift(try rustCallWithError(FfiConverterTypeApiError_lift) {
    uniffi_genie_core_fn_func_api_send_turn_with_attachments(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),
        FfiConverterString.lower(conversationId),
...
public func apiSendTurnWithReplyCandidates(baseUrl: String, accessToken: String, conversationId: String, text: String, attachments: [TurnAttachment], replyCandidatesJson: String)throws  -> TurnOutcome  {
    return try  FfiConverterTypeTurnOutcome_lift(try rustCallWithError(FfiConverterTypeApiError_lift) {
    uniffi_genie_core_fn_func_api_send_turn_with_reply_candidates(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),
        FfiConverterString.lower(conversationId),
        FfiConverterString.lower(text),
...
public func apiStartConversation(baseUrl: String, accessToken: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeApiError_lift) {
    uniffi_genie_core_fn_func_api_start_conversation(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),$0
    )
})
...
public func apiTaskApprovals(baseUrl: String, accessToken: String, taskId: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeApiError_lift) {
    uniffi_genie_core_fn_func_api_task_approvals(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),
...
public func apiTaskApprove(baseUrl: String, accessToken: String, taskId: String, approvalId: String, decision: String)throws   {try rustCallWithError(FfiConverterTypeApiError_lift) {
    uniffi_genie_core_fn_func_api_task_approve(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),
...
public func apiTaskJson(baseUrl: String, accessToken: String, taskId: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeApiError_lift) {
    uniffi_genie_core_fn_func_api_task_json(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),
        FfiConverterString.lower(taskId),$0
    )
...
public func apiTaskStatus(baseUrl: String, accessToken: String, taskId: String)throws  -> TaskStatus  {
    ...
    uniffi_genie_core_fn_func_api_task_status(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),
        FfiConverterString.lower(taskId),$0
    )
...
public func apiUploadMeetingAudio(baseUrl: String, accessToken: String, meetingId: String, journalRoot: String)throws  -> UInt64  {
    ...
    uniffi_genie_core_fn_func_api_upload_meeting_audio(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),
...
public func apiWaitTask(baseUrl: String, accessToken: String, taskId: String, timeoutMs: UInt64)throws  -> TaskStatus  {
    return try  FfiConverterTypeTaskStatus_lift(try rustCallWithError(FfiConverterTypeApiError_lift) {
    uniffi_genie_core_fn_func_api_wait_task(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),
        FfiConverterString.lower(taskId),
...
public func apiWorkBriefNext(baseUrl: String, accessToken: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeApiError_lift) {
    uniffi_genie_core_fn_func_api_work_brief_next(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),$0
    )
})
...
public func apiWorkContext(baseUrl: String, accessToken: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeApiError_lift) {
    uniffi_genie_core_fn_func_api_work_context(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),$0
    )
})
...
public func apiWorkCorrect(baseUrl: String, accessToken: String, itemId: String, action: String, note: String)throws   {try rustCallWithError(FfiConverterTypeApiError_lift) {
    uniffi_genie_core_fn_func_api_work_correct(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),
...
public func apiWorkEvidence(baseUrl: String, accessToken: String, itemId: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeApiError_lift) {
    uniffi_genie_core_fn_func_api_work_evidence(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),
...
public func apiWorkReplySend(baseUrl: String, accessToken: String, sendJson: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeApiError_lift) {
    uniffi_genie_core_fn_func_api_work_reply_send(
        FfiConverterString.lower(baseUrl),
        FfiConverterString.lower(accessToken),
...
public func connectorAuthorizeUrl(providerId: String, clientId: String, redirectUri: String, scopes: [String], state: String, codeChallenge: String) -> String?  {
    ...
    uniffi_genie_core_fn_func_connector_authorize_url(
...
public func connectorConfiguredProviderIds(clientIds: [String: String]) -> [String]  {
    ...
    uniffi_genie_core_fn_func_connector_configured_provider_ids(
...
public func connectorExchangeCode(tokenUrl: String, providerId: String, clientId: String, redirectUri: String, code: String, codeVerifier: String, nowMs: UInt64) -> String  {
    return try!  FfiConverterString.lift(try! rustCall() {
    uniffi_genie_core_fn_func_connector_exchange_code(
...
public func connectorExchangeConfigured(providerId: String, clientId: String, clientSecret: String?, redirectUri: String, code: String, codeVerifier: String, nowMs: UInt64) -> String  {
    return try!  FfiConverterString.lift(try! rustCall() {
    uniffi_genie_core_fn_func_connector_exchange_configured(
        FfiConverterString.lower(providerId),
        FfiConverterString.lower(clientId),
...
public func connectorParseCallback(target: String) -> OauthCallback  {
    ...
    uniffi_genie_core_fn_func_connector_parse_callback(
...
public func connectorPkceChallenge(verifier: String) -> String  {
    return try!  FfiConverterString.lift(try! rustCall() {
    uniffi_genie_core_fn_func_connector_pkce_challenge(
...
public func connectorTokenUrl(providerId: String) -> String?  {
    return try!  FfiConverterOptionString.lift(try! rustCall() {
    uniffi_genie_core_fn_func_connector_token_url(
...
public func formatElapsed(ms: UInt64) -> String  {
    return try!  FfiConverterString.lift(try! rustCall() {
    uniffi_genie_core_fn_func_format_elapsed(
 ...
 */
public func genieCoreVersion() -> String  {
    return try!  FfiConverterString.lift(try! rustCall() {
    uniffi_genie_core_fn_func_genie_core_version($0
    )
})
}
/**
...
public func markMeetingUploaded(root: String, meetingId: String) -> Bool  {
    return try!  FfiConverterBool.lift(try! rustCall() {
    uniffi_genie_core_fn_func_mark_meeting_uploaded(
        FfiConverterString.lower(root),
        FfiConverterString.lower(meetingId),$0
    )
})
...
public func rankContext(query: ContextQuery, candidates: [ContextCandidate]) -> [ContextResult]  {
    ...
    uniffi_genie_core_fn_func_rank_context(
...
public func recordingSnapshot(input: RecordingInput) -> RecordingSnapshot  {
    return try!  FfiConverterTypeRecordingSnapshot_lift(try! rustCall() {
    uniffi_genie_core_fn_func_recording_snapshot(
...
public func scanRecoverable(root: String, active: String?) -> [RecoverableMeeting]  {
    ...
    uniffi_genie_core_fn_func_scan_recoverable(
        FfiConverterString.lower(root),
...
public func toWire(samples: [Float]) -> Data  {
    ...
    uniffi_genie_core_fn_func_to_wire(
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_genie_core_uniffi_contract_version()
    ...
    if (uniffi_genie_core_checksum_func_api_create_task() != 57207) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_dev_sign_in() != 26327) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_finish_meeting() != 55187) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_initial_profile() != 28927) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_library() != 12596) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_me() != 55733) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_meeting_segment_count() != 11706) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_personalization() != 32532) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_personalization_update() != 43773) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_plugin_catalog() != 21839) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_plugin_connect() != 9391) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_plugin_connections() != 59524) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_genie_core_checksum_func_api_send_turn_with_attachments() != 17484) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_send_turn_with_reply_candidates() != 55428) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_start_conversation() != 57441) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_task_approvals() != 40849) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_task_approve() != 24459) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_task_json() != 10708) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_task_status() != 56243) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_upload_meeting_audio() != 28958) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_wait_task() != 22180) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_work_brief_next() != 14882) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_work_context() != 33859) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_work_correct() != 61653) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_work_evidence() != 9366) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_api_work_reply_send() != 15379) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_connector_authorize_url() != 28962) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_connector_configured_provider_ids() != 54177) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_connector_exchange_code() != 39541) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_connector_exchange_configured() != 974) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_connector_parse_callback() != 13633) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_connector_pkce_challenge() != 62584) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_connector_token_url() != 40530) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_format_elapsed() != 31360) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_genie_core_version() != 633) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_mark_meeting_uploaded() != 29285) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_rank_context() != 65103) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_recording_snapshot() != 36836) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_scan_recoverable() != 7387) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_func_to_wire() != 62071) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_method_recordingsession_finish() != 13291) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_method_recordingsession_meeting_id() != 51928) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_method_recordingsession_push_samples() != 25021) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_method_recordingsession_recorded_ms() != 54812) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_method_recordingsession_set_link() != 26826) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_method_recordingsession_set_paused() != 51361) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_method_recordingsession_snapshot() != 37460) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_genie_core_checksum_constructor_recordingsession_start() != 42291) {
        return InitializationResult.apiChecksumMismatch
    }
...
public func uniffiEnsureGenieCoreInitialized() {
